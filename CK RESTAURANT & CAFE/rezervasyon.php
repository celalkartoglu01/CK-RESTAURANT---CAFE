    ...
    <body>
        <div style="width: 3000px; height:50px; background-color:orange;display: flex;align-items: center;">
            ...
            <div style="background-color:white; height: 150px;">
                ...
                <p style="position: absolute; display: inline-block; right: 530px; top: 132px; font-family: fantasy;"><a href="anasayfa.php" style="color: orange; font-size: 30px">Ana Sayfa</a></p>
                <p style="top: 132px; position: absolute; display: inline-block; right: 360px;font-family: fantasy;"><a href="hakkimizda.php" style="color: orange; font-size: 30px">Hakkımızda</a></p>
                <p style="right: 230px; top: 132px; position: absolute; display: inline-block; font-family: fantasy;"><a href="iletisim.php" style="color: orange;font-size: 30px">İletişim</a></p>
                <p class="menu-toggle"  style="position: absolute; display: inline-block; right: 130px; top: 132px; right: 120; font-family: fantasy;"><a style="color: orange;font-size: 30px">Menü</a></p>
                <div class="menu" style="width: 155px; position: absolute; left: 1670px; top:208px ; display: inline-block; background-color:orange; height: 345px;">
                    <ul>
                        <li><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="kahvalti.php">KAHVALTI</a></li>
                        ...
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">PİZZALAR</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">BURGER</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">MAKARNALAR</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">SALATALAR</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">KIRMIZI ET</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">İÇECEKLER</a></li>
                        <hr style="width: 154px; margin-left: -40px;">
                        <li style ><a style="color: white; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" href="baslangiclar.php">TATLILAR</a></li>
                ...
                <div style="width: 2200px; background-color: rgb(231, 102, 102); height: 180px;">
                    <br>
                    <h1 style="font-size: 50px; font-family: fantasy; color: white; text-align: center; width: 1840px;">REZERVASYON</h1>
                    ...
                    <ul style="font-size: 20px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; color: white; display: inline-block; position: absolute; right: 840px; margin-top: -19px;"><li>REZERVASYON</li></ul>
                </div>
                ...
                <div style="height: 1200px;">
                    <div style="display: inline-block; background-color:gray; height: 800px; width: 900px; position: absolute; top: 550px; right: 510px;">
                        <p style="font-size: 30px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;  text-align: center; color:white;">"Özel Tatlar İçin Özel Masa: Rezervasyonunuzu Şimdi Yapın!"</p>
                        <br>
                        <form action="rezervasyonkod.php" method="post" style=>
                            <br><br><br><br>
                            <label style="font-size: 25px; margin-left: 200px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" for="name">Adınız:</label>
                            <input style="width: 300px; height: 30px; margin-left: 30px;" type="text" id="name" name="name" required><br><br><br><br><br>

                            <label style="font-size: 25px; margin-left: 65px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" for="phone">Telefon Numaranız:</label>
                            <input style="display: inline-block; width: 300px; height: 30px; margin-left: 30px;" type="tel" id="phone" name="phone" required><br><br><br><br><br>
                        
                            <label style="font-size: 25px; margin-top: 50px; margin-left: 40px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" for="clock">Rezervasyon Saatiniz:</label>
                            <input style="display: inline-block; width: 300px; height: 30px; margin-top: 10px; margin-left:30px;" type="clock" id="clock" name="clock" required><br><br><br><br><br>
                        
                
                            <label style="position: absolute; margin-top: 50px; font-size: 25px; margin-left: 170px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" for="message">Notunuz:</label>
                            <textarea style="display: inline-block; width: 300px; height: 170px; margin-left: 310px;" id="message" name="message" rows="4" cols="40" required></textarea><br><br>
                        
                            <input style="margin-top: 10px; margin-left: 510px;" type="submit" value="Rezervasyon Yap">
                        </form>
                    </div>
                </div>
