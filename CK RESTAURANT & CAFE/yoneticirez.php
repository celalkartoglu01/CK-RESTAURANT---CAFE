    ...
    <body>
        <div style="width: 3000px; height:50px; background-color:orange;display: flex;align-items: center;">
            ...
            <div style="background-color:white; height: 150px;">
                ...
                <p style="position: absolute; display: inline-block; right: 300px; top: 152px; font-family: fantasy;"><a href="yoneticiletisim.php" style="color: orange; font-size: 30px">Şikayetler</a></p>
                <p style="position: absolute; display: inline-block; right: 170px; top: 152px; font-family: fantasy;"><a href="yoneticipaneli.php" style="color: orange; font-size: 30px">Çıkış Yap</a></p>
                ...
                <div style="width: 2200px; background-color: rgb(231, 102, 102); height: 180px;">
                    <br>
                    <h1 style="font-size: 50px; font-family: fantasy; color: white; text-align: center; width: 1840px;">REZERVASYONLAR</h1>
                    ...
                    <ul style="font-size: 20px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; color: white; display: inline-block; position: absolute; right: 800px; margin-top: -19px;"><li>REZERVASYONLAR</li></ul>
                </div>

            
                <div style="height: 1200px;">
                <br>
                <p style="font-size: 40px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;  text-align: center; color:gray;">Mevcut Rezervasyonlar</p>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>".$row["ad"]."</td><td>".$row["telno"]."</td><td>".$row["saat"]."</td><td>".$row["notlar"]."</td></tr>";
                }
            } else {
                echo "<tr><td colspan='4'>Henüz rezervasyon bulunmamaktadır.</td></tr>";
            }
            $conn->close();
        }
        ?>
